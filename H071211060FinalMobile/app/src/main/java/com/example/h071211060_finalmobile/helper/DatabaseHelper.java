package com.example.h071211060_finalmobile.helper;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    @SuppressLint("Range")
    public List<MovieResults> getFavoriteMovies() {
        List<MovieResults> favoriteMovies = new ArrayList<>();
        SQLiteDatabase db = getReadableDatabase();
    ...
    @SuppressLint("Range")
    public List<TVShowsResults> getFavoriteTVShows() {
        List<TVShowsResults> favoriteTVShows = new ArrayList<>();
        SQLiteDatabase db = getReadableDatabase();
        String query = "SELECT * FROM " + TABLE_FAVORITES +
                " WHERE " + COLUMN_TYPE + " = ?";
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                TVShowsResults tvShow = new TVShowsResults();
